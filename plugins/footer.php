<footer class="footer-standard-dark bg-extra-dark-gray">
        ...
        <div class="container">
            <div class="row equalize xs-equalize-auto">
                <div class="col-md-3 col-sm-6 col-xs-12 widget border-right border-color-medium-dark-gray sm-no-border-right sm-margin-30px-bottom xs-text-center">
                    ...
                    <!-- end logo -->
                    <p class="text-small width-95 xs-width-100"> At FE Advisory, it’s not about us.It’s about our client’s business potential. Our team dynamics and a controlled client base per partner, allows us to bring creativity in advisory solutions, poise our relationships with flexibility and bring much needed intimacy in execution of our projects</p>
                    <!-- start social media -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 widget border-right border-color-medium-dark-gray padding-45px-left sm-padding-15px-left sm-clear-both sm-no-border-right  xs-margin-30px-bottom xs-text-center">
                    ...
                    <p class="text-small display-block margin-15px-bottom width-80 xs-center-col"><?=$address?></p>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 widget padding-45px-left sm-padding-15px-left xs-text-center">
                    ...
                    <div class="text-small">Email 1: <a href="mailto:<?=$email1?>"><?=$email1?></a></div>
    ...
    <div class="bg-dark-footer padding-50px-tb text-center xs-padding-30px-tb">
        <div class="container">
            <div class="row">
                <!-- start copyright -->
                <div class="col-md-6 col-sm-6 col-xs-12 text-left text-small xs-text-center">Copyright &copy; <script>document.write(new Date().getFullYear());</script> 5element</div>
