                ...
                <div class="container nav-header-container">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-xs-5">
                            <a href="http://5eadvisory.com/" title="5elements" class="logo"><img src="management/<?=$logo_url?>" data-rjs="management/<?=$logo_url?>" class="logo-dark" alt="Pofo"><img src="management/<?=$logo_url?>" data-rjs="management/<?=$logo_url?>" alt="Pofo" class="logo-light default"></a>
                        </div>
                        <!-- end logo -->
