                            ...
                            <form role="form" method="post" action="" enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input  type="text" class="form-control co_form_dei" id="5-7"  value="<?=$name?>" name="name">
                                        <small id="wordAlert" class="float-right"></small>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">CEO section title</label>
                                        <input type="text" class="form-control co_form_dei" id="5-10"  value="<?=$title?>" name="title">
                                        <small id="wordAlert" class="float-right"></small>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control co_form_dei" id="3-10"  value="<?=$text?>" name="text">
                                        <small id="wordAlert" class="float-right"></small>
