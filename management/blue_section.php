                            ...
                            <form role="form" method="post" action="" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="6-8" class="form-control co_form_dei" rows="3" placeholder="Enter ..." name="text"><?=$text?></textarea>
                                        <small id="wordAlert" class="float-right"></small>
                                    ...
                                    <div class="form-group  col-md-6">
                                        <label for="exampleInputFile">Blue section image upload</label>
                                    ...
                                    <div style="margin-top:20px;" class="input-group">
                                        ...
                                        {
                                            ?>
                                            <img src="<?= $bs_image ?>" alt="" height="100px" width="200px">
                                            <?php
                                        }
                                        else{
                                            ?>
