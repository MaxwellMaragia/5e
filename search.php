            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-12 col-md-12 text-md-left" style="padding-bottom:-20px;">
                        <!-- start page title -->
                        <h1 class="alt-font text-extra-dark-gray font-weight-600 mb-0 text-uppercase">Search results for "<?=$keyword?>"</h1>
                ...
                <div class="row ">
                                ...
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="col-12 col-lg-6 blog-text">
                                        <div class="content margin-20px-bottom md-no-padding-left ">
                                            ...
                                            <div class="text-medium-gray text-extra-small margin-15px-bottom text-uppercase alt-font"><span>By <a class="text-medium-gray"><?=$author?></a></span>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<span><?=$row['date']?></span>&nbsp;&nbsp;&nbsp;</div>
                                        ...
                                        <a class="btn btn-very-small btn-dark-gray text-uppercase" href="insight?id=<?=$row['id']?>">Continue Reading</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    ?>
                        ...
                        <div class="col-12 text-center margin-100px-top px-0 sm-margin-50px-top position-relative wow fadeInUp">
                            <div class="pagination text-small text-uppercase text-extra-dark-gray justify-content-center">
                                <ul>
