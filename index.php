...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        {
            ?>
        <section class="parallax wow fadeIn" data-stellar-background-ratio="0.5" style=" background-position: 0px 3.23438px; visibility: visible; animation-name: fadeIn;margin-top:5px">
            <div class="opacity-medium bg-black"></div>
            <div class="container">
              <div class="row">
                <div class="col-md-12 text-center margin-50px-bottom sm-margin-70px-bottom xs-margin-50px-bottom">
                    <!-- <p class="alt-font margin-5px-bottom  text-medium-gray text-small">Get the most</p> -->
                    <h5 class=" alt-font text-white margin-20px-bottom font-weight-700 sm-width-100 xs-width-100">Testimonials</h5>
                    <span class="separator-line-horrizontal-medium-light2 bg-custom-yellow display-table margin-auto width-100px"></span>
                </div>
              </div>
