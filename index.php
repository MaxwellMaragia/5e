...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <section class="wow fadeIn no-padding parallax xs-background-image-center" data-stellar-background-ratio="0.5" >
            <div class="opacity-extra-medium bg-black">
              <video playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
                <source src="management/videos/Fireplace - 1971.mp4" type="video/mp4">
              </video>
            </div>
            ...
            <div class="container">
                <div class="row">
                  <div class="col-md-8 col-sm-11 col-xs-12 center-col text-center margin-six-bottom xs-margin-30px-bottom">
                       <div class="alt-font text-custom-blue margin-5px-bottom ">Our services</div>
                ...
                <div class="row">
                    ...
                    {
                        ?>
                    <div class="col-md-4 col-sm-6 margin-40px-bottom feature-box-12 sm-padding-35px-tb sm-center-col wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
                        <div class="feature-icon-box icon-medium text-medium-gray bg-white">
                          <i class="<?=$get_service['icon']?> icon-medium text-custom-blue"></i>
                        </div>
                        <div class="feature-content-box padding-30px-left">
                            <div class="alt-font text-extra-dark-gray text-medium"><?=$get_service['heading']?></div>
                            <div>Read more...</div>
                        </div>
                        <div class="hover-content-box padding-35px-all" style="background:#23225E">
                            <div class="alt-font text-custom-yellow"><?=$get_service['heading']?></div>
                            <div class="text-white"><?=$get_service['body']?></div>
                        </div>
                    </div>
                  <?php }?>
                    <!-- end rotate box item -->
        ...
        <section class="parallax one-second-screen parallax-feature-box sm-height-auto" data-stellar-background-ratio="0.3" style="background-image:url('management/images/homepage-9-parallax-img2.jpg');">
        ...
        {
            ?>
        <section class="parallax wow fadeIn" data-stellar-background-ratio="0.5" style=" background-position: 0px 3.23438px; visibility: visible; animation-name: fadeIn;margin-top:3px">
